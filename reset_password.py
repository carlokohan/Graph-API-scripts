...
# https://learn.microsoft.com/en-us/graph/api/user-revokesigninsessions?view=graph-rest-1.0&tabs=http
        ...
        # get object id
        object_id = 'emailC@your_domain.onmicrosoft.com'
        request_url = resource + 'v1.0/users/' + object_id + '/authentication/methods/xxxx/resetPassword'
